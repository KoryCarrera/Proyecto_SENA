...
--
-- Servidor: localhost
-- Tiempo de generación: 10-01-2026 a las 19:46:56
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_obtener_caso_por_id` (IN `p_id_caso` INT)  COMMENT 'Devuelve un solo caso con toda la información relacionada, usando su ID' BEGIN
    SELECT 
        c.id_caso,
        CONCAT(u.nombre, ' ', u.apellido) AS comisionado,
        c.fecha_inicio,
...
(6, '1013342119', 4, '2025-12-02 16:19:00', NULL, 2, 5, 'jiji jaja jiji jaja jojojojojo'),
(7, '11223344', 4, '2025-12-02 17:04:52', NULL, 2, 1, '3123131dasda dad w g<AW fw ege hd hgg'),
(8, '1013342119', 1, '2026-01-05 09:00:00', NULL, 1, 1, 'Reporte de desinformación en redes sociales sobre operativos en frontera.'),
(9, '1013342119', 1, '2026-01-06 14:30:00', NULL, 2, 2, 'Solicitud de verificación de datos sobre el censo electoral.'),
(10, '112233', 1, '2026-01-07 08:15:00', NULL, 1, 1, 'Denuncia por suplantación de identidad en portales gubernamentales.'),
(11, '112233', 1, '2026-01-07 10:00:00', NULL, 3, 3, 'Inconsistencia en los reportes de seguridad ciudadana enviados al PQRSD.'),
(12, '11223344', 1, '2026-01-06 11:00:00', NULL, 1, 2, 'Seguimiento a la cadena de noticias falsas sobre el precio de la canasta básica.'),
(13, '11223344', 1, '2026-01-07 13:00:00', NULL, 2, 1, 'Petición de transparencia sobre los fondos destinados a ciberseguridad.'),
(14, '123456', 1, '2026-01-05 16:45:00', NULL, 1, 3, 'Análisis de ataques de bots detectados en la última semana.'),
(15, '123456', 1, '2026-01-07 15:20:00', NULL, 2, 2, 'Reclamo por demora en la atención de casos de urgencia tipo A.');
...
(1, '31199437', '2025-12-30 20:19:07', 'PDF', 'artjrytj'),
(2, '31199437', '2025-12-30 20:22:42', 'PDF', 'artjrytj'),
(3, '31199437', '2025-12-30 20:22:56', 'PDF', 'rethnahnjatg'),
(4, '31199437', '2025-12-30 20:24:41', 'PDF', 'dgeghehg'),
(5, '31199437', '2025-12-30 20:26:41', 'PDF', 'fhgfhfhj'),
(6, '31199437', '2025-12-30 20:33:17', 'PDF', 'awtgagawghya'),
(7, '31199437', '2025-12-30 20:35:05', 'PDF', 'asgagasd'),
(8, '31199437', '2025-12-30 20:36:47', 'PDF', 'dshrthsdf'),
(9, '31199437', '2025-12-30 20:44:24', 'PDF', 'gfjrftkj'),
(10, '31199437', '2025-12-30 20:45:30', 'PDF', 'dfjndfgjm'),
(11, '31199437', '2025-12-30 20:46:20', 'PDF', 'jredfm'),
(12, '31199437', '2025-12-30 20:50:36', 'PDF', 'tjrtjk'),
(13, '31199437', '2025-12-30 20:53:05', 'PDF', 'rehewshews'),
(14, '31199437', '2025-12-30 20:56:28', 'PDF', 'rehrh'),
(15, '31199437', '2025-12-30 21:01:18', 'PDF', 'rnenern'),
(16, '31199437', '2025-12-30 21:03:01', 'PDF', 'afjhjkvfghakg'),
(17, '31199437', '2025-12-30 21:03:53', 'PDF', 'afjhjkvfghakg'),
(18, '31199437', '2025-12-31 21:21:09', 'PDF', 'R<HN<HN<HHATJATNJTJ'),
(19, '31199437', '2026-01-07 13:55:01', 'PDF', 'example example'),
(20, '31199437', '2026-01-07 13:57:53', 'PDF', 'herhehj'),
(21, '31199437', '2026-01-07 14:00:25', 'PDF', '6jwq6j6'),
(22, '31199437', '2026-01-07 14:07:19', 'PDF', 'rethqthjt6hj'),
(23, '31199437', '2026-01-07 14:07:57', 'PDF', 'rethqthjt6hj'),
(24, '31199437', '2026-01-07 14:08:47', 'PDF', 'q5h5hq56ht'),
(25, '31199437', '2026-01-07 14:12:37', 'PDF', 'qj5jq56jq564'),
(26, '31199437', '2026-01-07 14:24:56', 'PDF', 'El sistema ha demostrado una estabilidad del 98.5% bajo carga operativa. Como recomendación técnica, se sugiere realizar una auditoría de logs quincenal para asegurar la integridad de la base de datos de casos y optimizar el proceso de cierre de incidencias pendientes. El cumplimiento de metas de atención se mantiene dentro de los umbrales institucionales establecidos para el año 2026.');
...
('1013342119', 'Isaac', 'Carvajal', 'isaac@gmail.com', 2, '$2y$10$XJPcDeP8NIq87Z1wuKvrreLIUkUzNqyfY1yOD0K46Bi70jMs3AImi', '2025-11-24 06:54:17', '2025-12-10 11:26:13', 1, ''),
...
('31199437', 'Yldegar', 'Alvarez', 'kory.carrera.dev@gmail.com', 1, '$2y$10$YUBDZSJqh2/LCH9jlPeeJei1i.4P/zYGPYRTCHUK2qjDbK3qE7K6S', '2025-11-24 07:46:37', '2026-01-07 14:22:32', 1, ''),
...
--
ALTER TABLE `caso`
  MODIFY `id_caso` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PK de casos', AUTO_INCREMENT=16;
...
--
ALTER TABLE `informe`
  MODIFY `id_informe` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PK para ubicar y relacionar', AUTO_INCREMENT=27;
...
--
ALTER TABLE `procesoorganizacional`
  MODIFY `id_proceso` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PK para ubicar y relacionar', AUTO_INCREMENT=5;
...
--
ALTER TABLE `tipo_caso`
  MODIFY `id_tipo_caso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
